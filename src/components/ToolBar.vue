<template>
  ...
  >
    ...
    <button
      class="btn btn-primary btn-xs join-item"
      @click="feature.enableTable"
      v-if="!feature.tableEnabled"
    >
      开启 Table
    </button>
    <button
      class="btn btn-primary btn-xs join-item"
      @click="feature.disableTable"
      v-if="feature.tableEnabled"
    >
      关闭 Table
    </button>
    <button
      class="btn btn-primary btn-xs join-item"
      @click="feature.enableDraw"
      v-if="!feature.drawEnabled"
    >
      开启 Draw
    </button>
    <button
      class="btn btn-primary btn-xs join-item"
      @click="feature.disableDraw"
      v-if="feature.drawEnabled"
    >
      关闭 Draw
    </button>
