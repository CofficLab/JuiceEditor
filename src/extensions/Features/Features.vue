...
<template>
    <node-view-wrapper class="features">
        <div class="h-full  w-full px-1  mt-24 text-slate-700">
            ...
            <div id="box" ref="box" class="max-w-4xl mx-auto p-0">
                <div id="section1" :class="cardClass1">
                    ...
                    <div :class="menuClass" class="w-48 mb-1 mt-12">
                        <div v-for="color in colorClass"
                            class="w-7 h-7 flex items-center justify-center rounded-full p-1" :key="color">
                    ...
                    <div id="link-list" class="flex flex-col gap-2 justify-between">
                        <div id="link" :class="cardClass3">
                            ...
                            <div class="flex justify-start pr-24 ml-0 mt-2">
                                <p class="text-nowrap">Created by <b
                                        class="rounded-2xl p-1">https://cofficlab.github.io</b>
                                    with love
                                </p>
                            </div>
                        </div>
